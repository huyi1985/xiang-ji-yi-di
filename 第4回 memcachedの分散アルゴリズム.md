...
作为Perl语言的memcached client library的Cache::Memcached是由memcached的作者Brad Fitzpatrick开发的，即所谓的正统的library。
...
在Cache::Memcached中，为了求出哈希值，要用到CRC。
...
有关Consistent Hashing的思路在很多地方都有介绍，比如mixi的工程师博客等。因此在这里我就简单讲解一下。
