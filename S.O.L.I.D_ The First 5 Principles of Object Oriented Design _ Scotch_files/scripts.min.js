...
$(document).ready(function(){$("body").hasClass("single")&&($(".twitter-button, .facebook-button, .googleplus-button, .share-total").click(function(e){e.preventDefault()}),$(".share-stat-btns .twitter-button").sharrre({share:{twitter:!0},template:'<span class="icon ion-social-twitter"></span> {total}',enableHover:!1,enableTracking:!0,buttons:{twitter:{via:"scotch_io"}},click:function(e){e.simulateClick(),e.openPopup("twitter")}}),$(".share-stat-btns .facebook-button").sharrre({share:{facebook:!0},template:'<span class="icon ion-social-facebook"></span> {total}',enableHover:!1,enableTracking:!0,click:function(e){e.simulateClick(),e.openPopup("facebook")}}),$(".share-stat-btns .googleplus-button").sharrre({share:{googlePlus:!0},template:'<span class="icon ion-social-google"></span> {total}',enableHover:!1,enableTracking:!0,click:function(e){e.simulateClick(),e.openPopup("googlePlus")}}),$(".legend-social .twitter-button").sharrre({share:{twitter:!0},template:'<span class="icon ion-social-twitter sbg-twitter"></span> {total}',enableHover:!1,enableTracking:!0,buttons:{twitter:{via:"scotch_io"}},click:function(e){e.simulateClick(),e.openPopup("twitter")}}),$(".legend-social .facebook-button").sharrre({share:{facebook:!0},template:'<span class="icon ion-social-facebook sbg-facebook"></span> {total}',enableHover:!1,enableTracking:!0,click:function(e){e.simulateClick(),e.openPopup("facebook")}}),$(".legend-social .googleplus-button").sharrre({share:{googlePlus:!0},template:'<span class="icon ion-social-google sbg-googleplus"></span> {total}',enableHover:!1,enableTracking:!0,click:function(e){e.simulateClick(),e.openPopup("googlePlus")}}),$(".share-total").sharrre({share:{facebook:!0,twitter:!0,googlePlus:!0},template:'<span class="share-number-total">{total}</span> shares',enableHover:!1})),$(".card-share-number").sharrre({share:{facebook:!0,twitter:!0,googlePlus:!0},template:'<span class="icon ion-ios-pulse"></span> {total} Shares',enableHover:!1})});
$(document).ready(function(){$("#disqus_thread").waypoint({handler:function(){var e=document.createElement("script");e.async=!0,e.type="text/javascript",e.src="//scotchwebdevelopment.disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(e),this.destroy()},offset:1500})});
$(document).ready(function(){function e(){var e=[];$.each($(".page-content-inside h2"),function(n,t){var l=t.innerText;link=l.replace(/ /g,"-").replace(/\./g,"-").replace(/#/g,"-"),link=link.toLowerCase(),e.push({linkText:l,link:link}),$(this).attr("id",link),$(this).html('<a href="#'+link+'"><span class="heading-link icon ion-link"></span> '+$(this).html()+"</a>")});var n=[];$.each(e,function(e,t){n.push('<option value="'+t.link+'">'+t.linkText+"</option>")}),$(".legend-outline").removeClass("hidden"),$(".legend-outline select").html(n.join(""))}$("body").hasClass("single")&&($(".page-content-inside h2").length>3&&e(),$(".legend-outline select").change(function(){var e=$(this).val();$("html, body").animate({scrollTop:$("#"+e).offset().top+-50},1e3)}),$(".page-content-inside h2").waypoint({handler:function(e){if("down"==e){var n=this.element.id;$(".legend-outline select").val(n)}else $(".legend-outline option:selected").removeAttr("selected").prev("option").attr("selected","selected");$(".legend-outline select").addClass("pop-out"),setTimeout(function(){$(".legend-outline select").removeClass("pop-out")},200)},offset:"130px"}))});
...
function isValidEmailAddress(F){var e=new RegExp(/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i);return e.test(F)}$(document).ready(function(){$("form#login, form#register").submit(function(F){$(".login-message, .register-message").removeClass("showing").html("");var e=$(this),a=$(this).attr("id"),u={};if(u.redirect_to=e.find("input[name=redirect_to]").val(),u.username=e.find("input[name=username]").val(),u.password=e.find("input[name=password]").val(),"login"==a&&(u.action="ajaxlogin",u.security=e.find("input[name=security]").val()),"register"==a){if(u.action="ajaxregister",u.security=e.find("input[name=signonsecurity]").val(),u.email=e.find("input[name=email]").val(),u.password_confirm=e.find("input[name=password_confirm]").val(),u.newsletter=e.find("input[name=newsletter_signup]").is(":checked"),u.password!=u.password_confirm)return $(".register-message").addClass("showing").html("Passwords don't match."),!1;if(!isValidEmailAddress(u.email))return $(".register-message").addClass("showing").html("Please enter a valid email address."),!1}$.ajax({type:"POST",dataType:"json",url:e.attr("action"),data:u,success:function(F){F.loggedin===!0?location.reload():("login"==a&&$(".login-message").addClass("showing").html(F.message),"register"==a&&$(".register-message").addClass("showing").html(F.message))}}),F.preventDefault()}),$("form#forgot").submit(function(F){$(".login-message, .register-message").removeClass("showing").html("");var e=$(this),a={};a.action="ajaxforgotpassword",a.user_login=e.find("input[name=user_login]").val(),a.security=e.find("input[name=forgotsecurity]").val(),$.ajax({type:"POST",dataType:"json",url:e.attr("action"),data:a,success:function(F){console.log(F),$(".login-message").addClass("showing").html(F.message)}}),F.preventDefault()})});
$(document).ready(function(){$("body").hasClass("category")&&$(".pagination a").click(function(o){var a=$(this).attr("href");a=a.replace("category/",""),a=a.replace(".io/",".io/category/"),a=a.replace(".local/",".local/category/"),window.location.href=a,o.preventDefault()}),$(window).scroll(function(){var o=$(window).scrollTop();o/=50,$(".legend-social a span").css({"-moz-transform":"rotate("+o+"deg)","-webkit-transform":"rotate("+o+"deg)","-o-transform":"rotate("+o+"deg)","-ms-transform":"rotate("+o+"deg)",transform:"rotate("+o+"deg)"})});var o=$(".sidebar-option").length,a=Math.floor(Math.random()*o);$(".sidebar-option:eq("+a+")").addClass("hidden"),$(".clickable").click(function(){window.document.location=$(this).attr("href")})});